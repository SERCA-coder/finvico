                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="service-details-content">
                                    <h2 className="mb-xxl-6 mb-xl-5 mb-4">Unlocking Growth Through Equity Investments</h2>
                                    <p className="mb-xxl-6 mb-xl-5 mb-4">
                                        Equities, or stocks, represent ownership in a publicly-traded company and are a fundamental component of any growth-oriented investment strategy. At PF-MGMNT, we provide access to global equity markets, backed by expert research and analysis to help you navigate the complexities of stock investing.
                                    </p>
                                    
                                    <h4 className="mb-xxl-4 mb-3">Our Equity Investment Services</h4>
                                    <p className="mb-xxl-6 mb-xl-5 mb-4">
                                        We offer a diverse range of equity services designed to align with your investment goals, from long-term value investing to short-term trading opportunities.
                                    </p>
