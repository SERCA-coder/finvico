                            ...
                            <div className="col-lg-8">
                                <div className="service-details-content">
                                    <div className="investment-card-fixed p-xxl-8 p-xl-6 p-5 h-100 d-flex flex-column mb-5 position-relative" data-aos="fade-up" data-aos-duration="1200">
                                        ...
                                        <h2 className="mb-xxl-6 mb-xl-5 mb-4 text-center">Secure Returns Through Fixed Income Investments</h2>
                                        <p className="mb-xxl-6 mb-xl-5 mb-4 text-center">
                                            Fixed income securities provide a stable foundation for any investment portfolio. At Finvico, we offer access to a diverse range of fixed income instruments, from government bonds to corporate debt, helping you generate consistent income while managing risk effectively.
                                        </p>
                                        ...
                                        <div className="contact-info">
                                            ...
                                            <div className="contact-item d-flex align-items-center gap-3 mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="mailto:info@finvico.com">info@finvico.com</a>
                                                </div>
                                            </div>
