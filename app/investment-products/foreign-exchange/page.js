                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="investment-card-forex p-xxl-8 p-xl-6 p-5 h-100 d-flex flex-column mb-5 position-relative" data-aos="fade-up" data-aos-duration="1200">
                                    ...
                                    <h2 className="mb-xxl-6 mb-xl-5 mb-4 text-center">Navigating the Global Currency Markets</h2>
                                    <p className="mb-xxl-6 mb-xl-5 mb-4 text-center">
                                        The Foreign Exchange (FX) market is the largest and most liquid financial market in the world. At Finvico, we provide our clients with direct access to this dynamic market, offering competitive pricing, cutting-edge technology, and expert insights to help you manage currency risk and seize opportunities.
                                    </p>
